...
3. This I like the most, you get to see EXIF data like __aperture, shutter speed, iso__ etc when you click on any image automatically.

## Quick Start
If you know a tad about tech, and love taking pictures then this open-source project may help you setup a website to showcase
all your creations. And not just that, with this you do not need to pay a single dime to host your website as it's hosted by GitHub for __free__.
...
6. And that's it, your website is set. To view, go to whatever URL you have in the CNAME file, and if you don't have one, you can go to [[yourusername].github.io/photography](http://yourusername.github.io/photography)
...
4. Copy all your pictures (possibly jpg, the largest size available) and put them inside `images` directory
...
## Credits
Thanks to [AJ](https://twitter.com/ajlkn) for the website template which Ram Patra enhanced for [jekyll](http://jekyllrb.com/).
